...
class MolTrain(object):
    ...
    def __init__(self, 
                ...
                fusion_location='after',   #残基特征融合位置,包括['before','layer{num}','after']
                **params,
                ):
        """
        ...
        :param comparative_learning: bool, default= False,设置可进行对比学习
        :param fusion_location: str, default= ='layer6',残基特征融合位置,包括['before','layer{num}','after']
        """
        ...
        config.comparative_learning = comparative_learning
        config.fusion_location = fusion_location
