...
from .models import UniMolModel, UniMolV2Model,ToxMolModel
...
class UniMolRepr(object):
    ...
    def __init__(self, data_type='molecule', 
        ...
        elif model_name == 'toxmol':
            self.model = ToxMolModel(output_dim=1, model_size=model_size,comparative_learning=False).to(self.device)
        else:
